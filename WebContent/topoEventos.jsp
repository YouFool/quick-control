...
<html lang="pt-BR">
  <head>
    ...
    <title>QuickControl - Eventos</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <header>
    <nav class="top-nav blue-grey">
      ...
      <ul id="nav-mobile" class="side-nav fixed" style="transform: translateX(-100%);">
          <li class="med"><div class="row center"><a class="active2" href="\teste\interno.jsp"><i class="large material-icons">home</i></a></div></li>
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="#" class="white-text">Notificações</a></li>
